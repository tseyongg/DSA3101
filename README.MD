...
After the image is built (ignore the warnings), replace hf_xxxxxxxxxxxxxxxxxxxxxxxxxxx with your own generated API Key, then:

```shell
docker run -p 8501:8501 -e HF_API_KEY=hf_xxxxxxxxxxxxxxxxxxxxxxxxxxx my-streamlit-app
```
