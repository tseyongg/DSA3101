...
col1, col2, col3, padding = st.columns([1, 0.8, 1, 5])

with col1:
    thumbs_up = st.button("👍 Thumbs Up", key="thumbs_up")
with col2:
    neutral = st.button(" 👌 Neutral", key="neutral")
with col3:
    thumbs_down = st.button("👎 Thumbs Down", key="thumbs_down")
